...
- one complete, source-aligned teacher delivery program in editable Word and matched PDF formats;
- a 60-block delivery ledger with Task 5.1, 5.2 and 5.3 clearly marked as alternative pathways;
- complete teacher guides for Tasks 1–7 and the three Task 5 options, with named files attached to every delivery block;
- a searchable, filterable index of 425 exact Staffroom files, with folders retained only as secondary fallbacks;
- four labelled task-stage banners and seven restrained teaching-purpose colour categories, with visible text labels so colour is never the only cue;
- transparent source, assessment, privacy and currency boundaries.
